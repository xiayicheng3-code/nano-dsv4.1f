...
Legacy step coordinates and late-indexer probe locations remain meaningful only as historical/synthetic benchmark settings. They must not be interpreted as the production 3B-token schedule.
